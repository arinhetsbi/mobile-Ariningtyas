...
import id.arin.tokocepat.activity.data_barang.data.ResultDataBarang
import id.arin.tokocepat.activity.login.data.ResultLogin
import id.arin.tokocepat.activity.penjualan.data.ResultKeranjang
import id.arin.tokocepat.activity.penjualan.data.ResultSearchBarang
import id.arin.tokocepat.activity.report.detail.data.ResultItemKeranjang
import id.arin.tokocepat.response.ResultSimple
import retrofit2.Call
import retrofit2.http.Field
import retrofit2.http.FormUrlEncoded
import retrofit2.http.POST

interface tokocepatService {
